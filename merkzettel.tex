...
\DeclareDocumentCommand{\memorysheetpage}{}{
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \ifthenelse{\boolean{printpagenumbers}}{
            \node[anchor=south,outer sep=0pt] at (current page.south) {Seite \thepage};
        }{}

        % Credits
        \ifthenelse{\boolean{printcredits}}{
            \node[anchor=north,outer sep=0pt,font=\scriptsize] at (current page.north) {Created with: \url{https://github.com/Rdeisenroth/memorysheet}};
        }{}
    \end{tikzpicture}
}
